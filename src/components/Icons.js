...
export const FacebookIcon = (className, ...rest) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em"  {...rest} className={`w-full h-auto ${className}`}>
    <path
      fill="#1877F2"
      d="M21.35 0H2.65A2.65 2.65 0 0 0 0 2.65v18.7A2.65 2.65 0 0 0 2.65 24H12v-9.28H9.18V12H12V9.94C12 7.39 13.49 6 15.83 6c1.09 0 2.4.2 2.4.2v2.64h-1.34c-1.33 0-1.74.83-1.74 1.68V12h2.97l-.48 3.72h-2.49V24h4.88A2.65 2.65 0 0 0 24 21.35V2.65A2.65 2.65 0 0 0 21.35 0"
    />
  </svg>
)
